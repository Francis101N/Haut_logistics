...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <header class="topbar" data-navbarbg="skin5" style="background-color:#ff4424;">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark" style="background-color:#ff4424;">
        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="page-breadcrumb bg-white"><br>
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title" style="color:#013d5f;">Change Password</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title" style="color:#013d5f;">Enter your new password</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="myfields">
                                        <input type="submit" value="Change Password" class="form-control btn text-light" style="background-color:#013d5f;">
                                    </div>
                                </div>
                            </div>
                            </form>
