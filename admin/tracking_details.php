...
$query = 'SELECT * FROM tracking_details order by id desc';
$trackings_result = mysqli_query($conn,$query);
$trackings_num = mysqli_num_rows($trackings_result);
...
<head>
    ...
    <title>LOGISTICS | Tracking Details</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title" style="color:#013d5f;">Trackings</h3>
                            <p class="text-muted" style="color:#013d5f;">Tracking <code>details</code></p>
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Order Token</th>
                                            <th class="border-top-0">Description</th>
                                            <th class="border-top-0">Status</th>
                                            <th class="border-top-0">Current Location</th>
                                    ...
                                    <tbody>
                                        <?php
                                          ...
                                          for($i = 0; $i < $trackings_num; $i++) {
                                                $trackings_rows = mysqli_fetch_array($trackings_result);
                                           ?>
                                        <tr>
                                            <td>00<?php echo $trackings_rows['id']; ?></td>
                                            <td><?php echo $trackings_rows['Order_token']; ?></td>
                                            <td><?php echo $trackings_rows['Description']; ?></td>
                                            <td><?php echo $trackings_rows['Status']; ?></td>
                                            <td><?php echo $trackings_rows['Location']; ?></td>
                                            <td><?php echo $trackings_rows['Delivered_date']; ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
