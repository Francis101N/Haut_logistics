                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="myfields">
                                        ...
                                        <input type="text" name="tracking_no" value="<?php echo $row['Tracking_no']; ?>" class="form-control" readonly><br>
                                        <label>Fullnames</label>
                                       <input type="text" name="fullnames" value="<?php echo $row['R_fullname']; ?>" class="form-control">
                                        <br>
                                        <label>Email</label>
                                        <input type="text" name="email" value="<?php echo $row['R_email']; ?>" class="form-control"><br>
                                        <label>Freight Class</label>
                                        <input type="text" name="freight_class" value="<?php echo $row['Freight_class']; ?>" class="form-control"><br>
                                        <label>Items</label>
                                        <input type="text" name="items" value="<?php echo $row['Items']; ?>" class="form-control"><br>
                                        <label>Weight</label>
                                        <input type="text" name="weight" value="<?php echo $row['Weight']; ?>" class="form-control"><br>
                                        <label>Length</label>
                                        <input type="text" name="length" value="<?php echo $row['length']; ?>" class="form-control"><br>
                                        <label>Description</label>
                                        <input type="text" name="description" class="form-control"><br>
                                        <label>Current location</label>
                                        <input type="text" name="current_location" class="form-control"><br>
