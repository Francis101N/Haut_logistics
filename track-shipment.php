...
<title>Track Shipment | Haut Logistics</title>
...
<div class="about-banner" >
    <div class="container">
        <div class="about-banner-head">Track Shipment</div>
    </div>
</div>
...
<div class="container">
    <div class="tab">
        ...
        <!-- <button class="tablinks" onclick="openCity(event, 'Paris')" id="defaultOpen"><span><img src="./dist/images/req2.png" class="img-fluid"></span> Packages Tracking</button> -->
        <button><span><img src="./dist/images/req1.png" class="img-fluid"></span> Packages Tracking</button>
    </div>
</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="contact_form-row">
                                    <p>Freight Class</p>
                                    <select class="form-select" >
                                        <option selected>Select freight class</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="contact_form-row">
                                    <p>Lenght</p>
                                    <select class="form-select" >
                                        <option selected>Enter length in cm</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="btn-sec" >
                                    <button style="width: 100%;">Get My Quote</button>
                                </div>
                            </div>
                        </div>
                    </div>
